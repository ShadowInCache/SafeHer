#!/usr/bin/env python3
"""Recording-level 5-fold StratifiedGroupKFold CV on the 6-class dataset
(PUSH+PULL merged into SUDDEN_MOVEMENT). Same protocol as every other CV
...
since that's the one that actually fits the ESP32-C3 flash budget.
"""
...
LABELS = ["NORMAL", "JERK", "SUDDEN_MOVEMENT", "SHAKING", "TWISTING", "FALL"]
...
print(f"\nNORMAL<->SUDDEN_MOVEMENT specifically:")
n = idx["NORMAL"]
print(f"  NORMAL -> SUDDEN_MOVEMENT: {cm[n, sm]}")
print(f"  SUDDEN_MOVEMENT -> NORMAL: {cm[sm, n]}")
